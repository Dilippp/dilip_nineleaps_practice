...
public final class AppConstants {
    ...
    public static final String ACCESS_FORBIDDEN = "Accessing the resource you were trying to reach is forbidden";
    ...
    public static final String INTERNAL_SERVER_ERROR = "Something went wrong at server side while processing the request";
}
